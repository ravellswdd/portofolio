...
function Contact() {
    return (
        <div className="contact">
            ...
            className='quotes'>"Technology knows no bounds, but our time does. It is in the finite that we find meaning—so let us create with intention. Each invention, each line of code, each idea we bring to life is a reflection of our values and vision. Instead of chasing relentless progress, we should take a moment to reflect: are we creating with meaning? When we recognize the limits of our time, we begin to value the depth and intention behind what we build."</motion.h1>
